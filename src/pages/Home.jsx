  ...
  return (
    <>
      <section  className='xl:mb-20 2xl:mb-30'>
        <div className="h-auto xl:h-200 bg-cover bg-center relative" style={{ backgroundImage: `url(src/assets/img/home-bg.jpg)` }}>
              ...
              {["home-trees.jpg", "home-lake.jpg", "home-mountain.jpg", "home-beach.jpg"].map((image, index) => {
                ...
                return (
                  <article key={index} className='relative w-70 h-48 overflow-hidden'>
                    <img className='transform transition-all duration-500 hover:scale-115 w-full h-full object-cover' src={`src/assets/img/${image}`} alt={image.split('.')[0]} />
